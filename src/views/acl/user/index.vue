<template>
    ...
    <el-card style="margin: 10px 0px;">
        ...
        <el-table @selection-change="selectChange" style="margin: 10px 0px;" border :data="userArr">
            ...
            <el-table-column label="用户别名" align="center" prop="name" show-overflow-tooltip></el-table-column>
            <el-table-column label="手机" align="center" prop="mobile" show-overflow-tooltip></el-table-column>
